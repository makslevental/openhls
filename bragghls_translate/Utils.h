...
#ifndef BRAGGHLS_SUPPORT_UTILS_H
#define BRAGGHLS_SUPPORT_UTILS_H
...
template <> struct DenseMapInfo<mlir::bragghls::PtrLikeMemRefAccess> {
  static mlir::bragghls::PtrLikeMemRefAccess getEmptyKey() {
    auto pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return mlir::bragghls::PtrLikeMemRefAccess(pointer);
  }
  static mlir::bragghls::PtrLikeMemRefAccess getTombstoneKey() {
    auto pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return mlir::bragghls::PtrLikeMemRefAccess(pointer);
  }
  static unsigned getHashValue(mlir::bragghls::PtrLikeMemRefAccess access) {
    return access.getHashValue();
  }
  static bool isEqual(mlir::bragghls::PtrLikeMemRefAccess lhs,
                      mlir::bragghls::PtrLikeMemRefAccess rhs) {
    return lhs == rhs;
  }
};
...
#endif // BRAGGHLS_SUPPORT_UTILS_H
