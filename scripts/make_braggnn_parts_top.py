...
launch_regs = [f"part_1_launch_{part_1_output}" for part_1_output in [part_1_outputs[t] for t in tdm_indices]]
land_wires = [f"part_1_land_{part_1_output}_wire" for part_1_output in [part_1_outputs[t] for t in tdm_indices]]
